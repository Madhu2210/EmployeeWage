...
public class EmpWage {
    ...
    // Constructor
    public EmpWage(String companyName, int empWagePerHr, int numMaxWorkingDay, int maxHrsInMonth) {
    ...
    public static void main(String[] args) {
        EmpWage dMartEmpWage = new EmpWage("INTEL", 20, 20, 100);
        dMartEmpWage.computeEmpWage();
        System.out.println(dMartEmpWage);
        EmpWage tcsEmpWage = new EmpWage("tcs", 16, 20, 100);
